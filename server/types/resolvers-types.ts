...
export type CancelJobApplicationInput = {
  id: Scalars['ID']['input'];
};
...
export type MutationCancelJobApplicationArgs = {
  input: CancelJobApplicationInput;
};
...
export type QuerySearchJobsArgs = {
  input?: InputMaybe<SearchJobsInput>;
};
...
export type ResolversTypes = {
  ...
  CancelJobApplicationInput: ResolverTypeWrapper<Partial<CancelJobApplicationInput>>;
...
export type ResolversParentTypes = {
  ...
  CancelJobApplicationInput: Partial<CancelJobApplicationInput>;
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  searchJobs?: Resolver<Array<ResolversTypes['Job']>, ParentType, ContextType, Partial<QuerySearchJobsArgs>>;
};
